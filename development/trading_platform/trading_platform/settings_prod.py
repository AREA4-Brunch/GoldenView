...
STORAGES = {
    # store and serve static files compressed, as it's more efficient
    'staticfiles': {
...
# In case of high traffic setup:
# https://docs.djangoproject.com/en/4.2/topics/http/sessions/#cached-sessions-backend
